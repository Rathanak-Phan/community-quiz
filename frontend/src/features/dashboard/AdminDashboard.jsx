    ...
    <div className="space-y-12 pb-20">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
        ...
        <div className="flex gap-4">
           <button className="bg-white border-2 border-slate-100 text-slate-900 px-6 py-3 rounded-2xl font-black text-xs tracking-widest hover:border-slate-200 transition-all">Export Logs</button>
           <button className="bg-slate-900 text-white px-6 py-3 rounded-2xl font-black text-xs tracking-widest hover:bg-blue-600 transition-all shadow-xl shadow-slate-900/10 hover:shadow-blue-600/20">System Status</button>
        </div>
      </div>
