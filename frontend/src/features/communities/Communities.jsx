      ...
      <div className="relative pt-8 md:pt-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-10 md:gap-12 text-center md:text-left">
          <div className="space-y-4 md:space-y-6 w-full md:w-auto">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-50 text-blue-600 text-[10px] font-black uppercase tracking-widest border border-blue-100 mx-auto md:mx-0">
               <Globe size={14} />
               Global Discovery
            </div>
