  ...
  if (loading) return (
    <div className="animate-pulse space-y-8">
        ...
        <div className="grid grid-cols-4 gap-6">
            {[1,2,3,4].map(i => <div key={i} className="h-40 bg-white rounded-[2.5rem]"></div>)}
        </div>
    </div>
  );
  ...
  return (
    <div className="space-y-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        {cards.map((card, i) => (
          <div key={i} className="bg-white rounded-[2.5rem] p-8 border border-slate-50 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.04)] hover:shadow-[0_32px_64px_-16px_rgba(0,0,0,0.1)] transition-all duration-500 group relative overflow-hidden">
      ...
      <div className="grid grid-cols-3 gap-8">
          <div className="col-span-2 bg-white rounded-[3rem] p-10 border border-slate-50 shadow-sm min-h-[400px] flex flex-col items-center justify-center text-center">
