...
import {
  ...
  Zap, Globe, Shield, Sparkles, Flame, Clock, ChevronRight, BookOpen
} from 'lucide-react';
...
const Home = () => {
  ...
  return (
    <div className="bg-white text-slate-900 overflow-hidden">
      <section className="relative min-h-[90vh] flex items-center pt-10 pb-20 md:pt-20 md:pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 relative z-10 w-full grid lg:grid-cols-2 gap-10 md:gap-20 items-center">
          <div className="space-y-10">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-50 border border-blue-100 text-blue-600">
               <span className="flex h-2 w-2 relative">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-blue-400 opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2 w-2 bg-blue-600"></span>
              </span>
              <span className="text-xs font-black uppercase tracking-widest">New: Real-time multiplayer mode</span>
            </div>

            <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-black leading-[1.05] tracking-tighter text-slate-900">
              Learning is <br/>
      ...
      <section className="bg-slate-900 py-16 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 md:px-6 flex flex-wrap justify-center md:justify-between gap-8 md:gap-12 relative z-10">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 md:mb-20 gap-6">
            <div className="space-y-4">
              ...
              <p className="text-slate-500 font-medium max-w-md">The most popular challenges being tackled by the community right now.</p>
            </div>
            <Link to="/quizzes" className="inline-flex items-center gap-2 text-sm font-black uppercase tracking-widest text-blue-600 hover:text-indigo-600 transition-all group">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-24 items-center">
            ...
            <div className="relative order-1 lg:order-2">
               ...
               {/* Floating Elements */}
               <div className="absolute -top-10 -left-10 p-6 bg-white rounded-3xl shadow-2xl border border-slate-50 animate-float">
                  <div className="flex items-center gap-4">
      ...
      <section className="py-20 md:py-32 bg-slate-50/50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-2xl mb-20">
            <h2 className="text-5xl font-black mb-6 text-slate-900">Built for the <br/> <span className="text-indigo-600">Modern Creator.</span></h2>
            <p className="text-xl text-slate-500 font-medium leading-relaxed">Tools designed to help you share knowledge and track student growth with precision.</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <BentoCard 
              ...
              className="lg:col-span-2 bg-white border-slate-100"
            />
            <BentoCard 
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-6">
            <div className="bg-gradient-to-br from-blue-600 via-indigo-600 to-blue-700 rounded-[2.5rem] md:rounded-[4rem] p-8 md:p-24 relative overflow-hidden flex flex-col md:flex-row items-center gap-12 md:gap-16 shadow-2xl shadow-blue-600/20">
              <div className="flex-1 space-y-8 relative z-10 text-center md:text-left text-white">
                ...
                <p className="text-xl opacity-80 font-medium max-w-xl mx-auto md:mx-0">
      ...
      <section className="py-32 relative bg-white">
        <div className="max-w-7xl mx-auto px-4 md:px-6 grid lg:grid-cols-2 gap-12 md:gap-24 items-center">
            <div className="relative group lg:block hidden">
             ...
             <div className="space-y-10">
                ...
                <h2 className="text-5xl md:text-7xl font-black tracking-tight text-slate-900">The Global <br/><span className="text-blue-600">Arena.</span></h2>
                ...
                <div className="space-y-4">
                  {loading ? (
                    ...
                    <div key={idx} className="flex items-center justify-between p-6 bg-slate-50 rounded-3xl border border-slate-100 hover:bg-white hover:shadow-xl transition-all group">
                      <div className="flex items-center gap-6">
                        <span className={`text-2xl font-black ${idx === 0 ? 'text-amber-500' : 'text-slate-300'}`}>0{idx + 1}</span>
                        <div className="flex items-center gap-4">
                          <img src={`https://i.pravatar.cc/100?img=${idx + 40}`} className="w-10 h-10 rounded-xl" alt={perf.name} />
                          <div>
                            <p className="font-black text-sm text-slate-900">{perf.name || 'User'}</p>
                            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">{perf.total_score || perf.score || '0'} Points</p>
                          </div>
                        </div>
                      </div>
                      <div className="flex items-center gap-2 px-4 py-1.5 bg-blue-50 rounded-full text-blue-600 font-black text-[10px] uppercase">
                        Active
                      </div>
                    </div>
                  ))}
                ...
                <div className="pt-6">
                  <button onClick={() => navigate("/leaderboard")} className="text-lg font-black text-blue-600 hover:text-indigo-600 flex items-center gap-3 group transition-all">
                    View Full Rankings
      ...
      <section className="py-32 bg-slate-50/50">
        <div className="max-w-7xl mx-auto px-4 md:px-6 text-center mb-16 md:mb-24">
          <h2 className="text-5xl md:text-7xl font-black mb-8 text-slate-900">What they <span className="text-blue-600">say.</span></h2>
          <p className="text-xl text-slate-500 font-medium max-w-2xl mx-auto">Join 100k+ learners already improving their skills.</p>
        </div>
      ...
      <section className="py-32 bg-white relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-4 md:px-6 text-center space-y-8 md:space-y-12 relative z-10">
          ...
          <p className="text-2xl text-slate-500 font-medium">Join Quizly today and master any subject through social learning.</p>
...
const QuizCard = ({ quiz, navigate }) => (
  ...
  >
    <div className="mb-8 relative rounded-3xl overflow-hidden aspect-video bg-slate-50 border border-slate-100">
      {quiz.image_url ? (
        <img src={quiz.image_url} alt={quiz.title} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
      ) : (
